...
Внизу кадра могут быть добавлены увеличенные копии плиток с зелёным контуром. Это не
дополнительные участники: используй копии только для точного чтения подписи. Координаты bbox
возвращай для плитки в верхнем полном кадре, а не для увеличенной копии.
...
2. При демонстрации экрана плитка может находиться в узкой верхней или боковой панели.
   Если пользователь транслирует свой экран, участники могут быть в отдельной маленькой
   плавающей панели поверх рабочего стола — часто в правом нижнем углу, но возможно в любом
   месте кадра. Такая панель является полноценным источником подписи говорящего.
...
3. Не считай выделением зелёные элементы внутри демонстрируемого приложения, текста,
   ...
   Не считай подписью говорящего верхний системный индикатор вроде «Идёт демонстрация»:
   искомое имя находится внутри плитки участника, обычно рядом с аватаром и значком микрофона.
